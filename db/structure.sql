...
CREATE TABLE "products" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "hospital_id" integer, "name" varchar(255), "price" integer, "dc_rate" float, "event_start_at" datetime, "event_end_at" datetime, "read_count" integer DEFAULT 0, "favorite_count" integer DEFAULT 0, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "hot" boolean DEFAULT 'f');
